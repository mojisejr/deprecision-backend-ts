...
},{"object-assign":"../../../node_modules/object-assign/index.js","vary":"../../../node_modules/vary/index.js"}],"config.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.API_URL_LOGIN_PRODUCTION = exports.API_URL_LOGIN = exports.API_URL_PRODUCTION = exports.HOME_PAGE_LIMIT = exports.API_URL = void 0;

var _cors = _interopRequireDefault(require("cors"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var API_URL = "http://localhost:3000/api/v1/products/";
exports.API_URL = API_URL;
var API_URL_PRODUCTION = "https://dry-reef-08166.herokuapp.com/api/v1/products";
exports.API_URL_PRODUCTION = API_URL_PRODUCTION;
var API_URL_LOGIN = "http://localhost:3000/api/v1/users/login";
exports.API_URL_LOGIN = API_URL_LOGIN;
var API_URL_LOGIN_PRODUCTION = "https://dry-reef-08166.herokuapp.com/api/v1/users/login";
exports.API_URL_LOGIN_PRODUCTION = API_URL_LOGIN_PRODUCTION;
var HOME_PAGE_LIMIT = 4;
exports.HOME_PAGE_LIMIT = HOME_PAGE_LIMIT;
},{"cors":"../../../node_modules/cors/lib/index.js"}],"../../../node_modules/core-js/modules/_global.js":[function(require,module,exports) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: _config.API_URL_LOGIN_PRODUCTION,
              data: {
                email: email,
                password: password
              }
...
exports.ok = ok;
},{"./pattern-validator":"pattern-validator.js"}],"model.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteProduct = exports.markAsRecommended = exports.saveProduct = exports.loadProduct = exports.state = void 0;
...
var state = {
  currentPage: 1,
  productId: (0, _helper.getLastPathFromUrl)(window.location.pathname)
};
exports.state = state;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios.default.get("".concat(_config.API_URL_PRODUCTION).concat(productId));
...
var saveProduct = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(productData) {
    var response;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            if (!(0, _patternValidator.isNullOrUndefined)(productData)) {
              _context2.next = 2;
              break;
            }
          ...
          case 2:
            _context2.next = 4;
            return _axios.default.post("".concat(_config.API_URL_PRODUCTION), productData);

          case 4:
            response = _context2.sent;
            return _context2.abrupt("return", (0, _helper.ok)(response.status) ? true : false);
  ...
  return function saveProduct(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            if (!(0, _patternValidator.isNullOrUndefined)(productId)) {
              _context3.next = 2;
              break;
            }
          ...
          case 2:
            _context3.next = 4;
            return _axios.default.delete("".concat(_config.API_URL_PRODUCTION).concat(productId));

          case 4:
            response = _context3.sent;
            return _context3.abrupt("return", (0, _helper.ok)(response.status) ? true : false);
...
var markAsRecommended = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(productId, recommendData) {
    var toggledData, response;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            toggledData = recommendData === "false" ? true : false;
            _context4.next = 5;
            return _axios.default.patch("".concat(_config.API_URL_PRODUCTION).concat(productId), {
              recommend: toggledData
            });

          case 5:
            response = _context4.sent;
            return _context4.abrupt("return", (0, _helper.ok)(response.status) ? true : false);
  ...
  return function markAsRecommended(_x4, _x5) {
    return _ref4.apply(this, arguments);
  };
}();

exports.markAsRecommended = markAsRecommended;
},{"axios":"../../../node_modules/axios/index.js","./config":"config.js","./helper":"helper.js","./pattern-validator":"pattern-validator.js"}],"mapper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.toProductData = void 0;

var toProductData = function toProductData(formValue) {
  var hasImageUrl = formValue.imageUrl === undefined ? "" : googleDriveImageViewGenerator(formValue.imageUrl);
  return {
...
exports.toProductData = toProductData;

var stringToArray = function stringToArray(str) {
  return str.split(",");
};

var googleDriveImageViewGenerator = function googleDriveImageViewGenerator(url) {
  if (url === null || url === undefined) {
    return;
  }

  var mainUrl = "https://drive.google.com/uc?export=view&id=";
  var imageId = getImageIdFromPublicUrl(url);
  var mergedUrl = mainUrl + imageId;
  return mergedUrl;
};

var getImageIdFromPublicUrl = function getImageIdFromPublicUrl(publicUrl) {
  var backSlashSplitedUrl = publicUrl.split("/");
...
var mapper = _interopRequireWildcard(require("./mapper"));
...
var btnMarkAsRecommend = document.querySelector(".btn-mark");
...
if (nextPage) {
  nextPage.addEventListener("click", function (e) {
    ...
    if (model.state.currentPage >= 1) {
      ...
      window.location.assign("/home?page=".concat(model.state.currentPage, "&limit=").concat(_config.HOME_PAGE_LIMIT));
    }
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              _context.next = 3;
              return model.deleteProduct(model.state.productId);
...
if (btnMarkAsRecommend) {
  btnMarkAsRecommend.addEventListener("click", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var recomendation, isUpdated;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              recomendation = document.getElementById("recommend").textContent;
              _context2.next = 4;
              return model.markAsRecommended(model.state.productId, recomendation);
...
if (btnSearch) {
  btnSearch.addEventListener("click", function (e) {
    ...
    var splittedInput = searchInput.split("=");
    var fieldName = splittedInput[0];
    var queryString = splittedInput[1];
    window.location.assign("/home?page=".concat(model.state.currentPage, "&limit=").concat(_config.HOME_PAGE_LIMIT, "&").concat(fieldName, "=").concat(queryString));
  });
...
if (productCards) {
  productCards.forEach(function (el) {
    return el.addEventListener("click", function (e) {
      e.preventDefault(); // console.log(e.target.parentElement.id);
      ...
      window.location.assign("products/".concat(model.state.productId));
    });
  });
}
...
if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    ...
    var password = document.getElementById("password").value; // console.log(`email: ${email}, password: ${password}`);
...
if (newProductForm) {
  newProductForm.addEventListener("submit", function (e) {
    ...
    var productData = mapper.toProductData(formValues);
...
},{"./config":"config.js","./login":"login.js","./model":"model.js","./mapper":"mapper.js"}],"../../../../../../npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
